...
namespace Emperia.Projectiles
{
    ...
    public class CoralShard : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            {
                int dust = Dust.NewDust(Projectile.Center, Projectile.width / 2, Projectile.height / 2, DustID.TerraBlade, Projectile.velocity.X, Projectile.velocity.Y, 0, default(Color), 0.6f);
