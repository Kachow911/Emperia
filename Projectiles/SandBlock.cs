...
namespace Emperia.Projectiles
{
    ...
    public class SandBlock : ModProjectile
    {
        ...
        {             
			...
			for (int i = 0; i < 2; i++)
			{
				int dust = Dust.NewDust(new Vector2(Projectile.position.X, (float) ((double) Projectile.position.Y + (double) Projectile.height - 16.0)), Projectile.width, 16, DustID.UnusedBrown, 0.0f, 0.0f, 0, new Color(), 1f);
