	...
	public class SeaStarProj : ModProjectile
	{
		...
		public override void Kill(int timeLeft)
		{
			if (Main.rand.Next(0, 4) == 0)
				Item.NewItem((int)Projectile.position.X, (int)Projectile.position.Y, Projectile.width, Projectile.height, ModContent.ItemType<Items.Sets.PreHardmode.Aquatic.SeaStar>(), 1, false, 0, false, false);
