...
namespace Emperia.Projectiles
{
	public class TrueHemisphereProj : ModProjectile
	{
		...
		public override void AI()
		{
			...
			if (timer % 5 == 0)
				Projectile.NewProjectile(projectile.position.X, projectile.position.Y, perturbedSpeed.X, perturbedSpeed.Y, mod.ProjectileType("TrueHemisphereSecond"), projectile.damage, projectile.knockBack, projectile.owner, 0, 0);
		}
