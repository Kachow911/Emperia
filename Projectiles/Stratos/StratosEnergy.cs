...
{
    public class StratosEnergy : ModProjectile
    {
        bool init = false;
		public override void SetStaticDefaults()
		{
			// DisplayName.SetDefault("Stratos Energy");
		}
		...
		public override void Kill(int timeLeft)
        {
			...
			{
				Vector2 vec = Vector2.Transform(new Vector2(-0.2f, 0), Matrix.CreateRotationZ(MathHelper.ToRadians(i)));
				vec.Normalize();
