...
namespace Emperia.Projectiles.TrueDaysVerge
{
    ...
    public class TrueBlueSword : ModProjectile
    {
		...
		public override void OnHitNPC(NPC target, int damage, float knockback, bool crit)
        {
			...
			direction.Normalize();
			Projectile.NewProjectile(placePosition.X, placePosition.Y, direction.X * 13f, direction.Y * 13f, mod.ProjectileType("DVP2"), projectile.damage, 1, Main.myPlayer, 0, 0);
		}
    }
}