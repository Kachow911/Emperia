...
namespace Emperia.Projectiles.TrueDaysVerge
{
    ...
    public class TrueBlueSword : ModProjectile
    {
		...
		/*public override void OnHitNPC(NPC target, int damage, float knockback, bool crit)
        {
			...
			direction.Normalize();
			Projectile.NewProjectile(placePosition.X, placePosition.Y, direction.X * 13f, direction.Y * 13f, ModContent.ProjectileType<DVP2>(), Projectile.damage, 1, Main.myPlayer, 0, 0);
		}*/
        //want a different effect for this anyway and it has a bug so die!!
    }
}