    ...
    public class GraniteRock2 : ModProjectile
    {
		...
		public override void Kill(int timeLeft)
        {
        	for (int i = 0; i < 360; i += 36)
			{
				...
				vec.Normalize();
				int num622 = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y), projectile.width, projectile.height, 240, 0f, 0f, 158, new Color(53f, 67f, 253f), 1f);
