...
namespace Emperia.Projectiles.Ice
{
	public class ChillSword: ModProjectile
	{
		...
		public override void Kill(int timeLeft)
		{
			for (int i = 0; i < 30; ++i)
			{
			  int index2 = Dust.NewDust(new Vector2(Projectile.position.X, Projectile.position.Y), Projectile.width, Projectile.height, 180, 0.0f, 0.0f, 15, Color.White, 2f);
		...
		public override void AI()
		{
			...
			{
				Dust.NewDust(new Vector2(Projectile.position.X, Projectile.position.Y), Projectile.width, Projectile.height,180, 0.0f, 0.0f, 15, new Color(53f, 67f, 253f), 0.8f);
			}
		}
