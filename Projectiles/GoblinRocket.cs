    ...
    public class GoblinRocket : ModProjectile
    {
		...
		public override void Kill(int timeLeft)
        {
			...
			for (int i = 0; i < 10; i++)
			{
				...
				Projectile.NewProjectile(Projectile.InheritSource(Projectile), Projectile.Center.X, Projectile.Center.Y, perturbedSpeed.X, perturbedSpeed.Y, ModContent.ProjectileType<FireBall>(), Projectile.damage / 2, 1, Main.myPlayer, 0, 0);
