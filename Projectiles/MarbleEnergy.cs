...
namespace Emperia.Projectiles
{
    ...
    public class MarbleEnergy : ModProjectile
    {
        ...
        {                                                           // |
			...
			int dust = Dust.NewDust(projectile.position, projectile.width, projectile.height, 66, 0f, 0f, 91, new Color(255, 255, 255), 1.5f);
