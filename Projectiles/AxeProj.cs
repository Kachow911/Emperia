	...
	public class AxeProj : ModProjectile
	{
        ...
        public override void Kill(int timeLeft)
		{
            ...
            if (Main.rand.Next(0, 4) == 0)
				Item.NewItem((int)Projectile.position.X, (int)Projectile.position.Y, Projectile.width, Projectile.height, ModContent.ItemType<Items.Weapons.BarbarianWaraxe>(), 1, false, 0, false, false);
			for (int i = 0; i < 5; i++)
			{
