...
{
	class MoltenHookItem : ModItem
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Molten Hook");
		}
		...
		public override void SetDefaults()
		{
			...
			*/
			...
			item.shoot = mod.ProjectileType("MoltenHookProjectile");
		}
	}
	class MoltenHookProjectile : ModProjectile
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Molten Hook");
		...
		public override bool? CanUseGrapple(Player player)
		{
			...
			if (hooksOut > 0) // This hook can have 3 hooks out.
			{
				return false;
			}
			return true;
		...
		public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor)
		{
			...
			while (distance > 30f && !float.IsNaN(distance))
			{
				...
				//Draw chain
				spriteBatch.Draw(mod.GetTexture("Items/Weapons/Volcano/MoltenHookChain"), new Vector2(center.X - Main.screenPosition.X, center.Y - Main.screenPosition.Y),
