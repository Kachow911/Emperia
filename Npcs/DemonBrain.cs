		 ...
		 public override void AI()
        {
            ...
            else
            {
                ...
                if (timer % 180 == 0)
                {
                    ...
                    Projectile.NewProjectile(NPC.GetSource_FromAI(), placePosition1.X, placePosition1.Y, direction1.X * 10f, direction1.Y * 10f, ModContent.ProjectileType<DemonBrainProj>(), 22, 1, Main.myPlayer, 0, 0);
                }
            }
