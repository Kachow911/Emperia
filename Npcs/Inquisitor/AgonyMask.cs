    ...
    public class AgonyMask : ModNPC
    {
        ...
        public override void AI()
        {
			...
			if (counter % 60 == 0)
			{
				...
				direction.Normalize();
				Projectile.NewProjectile(NPC.GetProjectileSpawnSource(), placePosition.X, placePosition.Y, direction.X * 7f, direction.Y * 7f, ModContent.ProjectileType<TearEnemy>(), 30, 1, Main.myPlayer, 0, 0);
			}
        }
    }
